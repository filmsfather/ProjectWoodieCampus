  ...
  theme: {
    extend: {
      ...
      maxWidth: {
        ...
        // 카드 규격 토큰
        'card-sm': '280px',   // 소형 카드 최대 너비
        'card-md': '320px',   // 중형 카드 최대 너비
        'card-lg': '400px',   // 대형 카드 최대 너비
      },
      // 최소 너비
      minWidth: {
        'card-sm': '240px',   // 소형 카드 최소 너비
        'card-md': '280px',   // 중형 카드 최소 너비
        'card-lg': '320px',   // 대형 카드 최소 너비
      },
    },
  },
  plugins: [
